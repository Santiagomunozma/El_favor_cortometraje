  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{ display: "flex", gap: space.xxs, marginBottom: space.xs }}
        >
        ...
        <p style={{ fontSize: fontSize.xxs, color: colors.accentDark }}>
          {currentLabel}
        </p>
